...
const sectionObserver=new IntersectionObserver(revealSec,{root: null,threshold:0.1,});
...
const imgObserever=new IntersectionObserver(loadImg,{root: null,threshold: 0, rootMargin:'200px', 
});
